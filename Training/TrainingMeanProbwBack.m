function [tumorIntensityProb tumorTextureProb backgroundIntensityProb backgroundTextureProb] = TrainingMeanProbwBack()
...
tumors = load('C:\Users\Public\Documents\Segmentation\RegionGrowing\Data\Tumores Segmentados\tumors.mat');
...
backgroundIntensityProb = zeros(256,1);
backgroundTextureProb = zeros(256,1);
...
for i=1:nImages
    ...
    tumorIntensityProb = tumorIntensityProb + intensityProbTumor;
    
    textureTumor = textureIm(tumor);
    textureProbTumor = imhist(textureTumor)/tumorSize(1);
    
    tumorTextureProb = tumorTextureProb + textureProbTumor;
    ...
    backgroundIntensityProb = backgroundIntensityProb + intensityProbBackground;
    
    textureBackground = textureIm(background);
    textureProbBackground = imhist(textureBackground)/backgroundSize(1);
    
    backgroundTextureProb = backgroundTextureProb + textureProbBackground;
    
end


tumorIntensityProb = tumorIntensityProb/nImages;
tumorTextureProb = tumorTextureProb/nImages;

backgroundIntensityProb = backgroundIntensityProb/nImages;
backgroundTextureProb = backgroundTextureProb/nImages;
